...
public class osmToWay {
    ...
    public osmToWay(String filename) {
        this(new File("E:/Files/Project/2019 Summer Research/MapMatching/data", filename));
    }
    ...
    public void addWay(Element node) {
